...
- **部署地址**: https://kssssxg.github.io/bxyaa-card/
- **生效时间**: 约 1-2 分钟
...
const BIO_API = 'https://cros.bxyaa.me/?url=' + encodeURIComponent('你的生平数据API');
```
...
```json
{
  ...
  "timeline": [
    ...
    { "year": "2026", "event": "发布个人主页 bxyaa-card" }
  ],
  "projects": [
    {
...
3. **代理服务器**：如果 API 不支持 CORS，可使用代理服务器（如 bio.html 中的 `cros.bxyaa.me`）
...
- 仓库: [bxyaa-card](https://github.com/kssssxg/bxyaa-card)
