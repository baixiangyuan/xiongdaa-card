...
- **GitHub Pages**: https://kssssxg.github.io/bxyaa-card/
...
- **Deploy URL**: https://kssssxg.github.io/bxyaa-card/
...
|------|------|--------|--------|
| Line ~319 | Name | `bxya` | Your nickname |
...
const BIO_API = 'https://cros.bxyaa.me/?url=' + encodeURIComponent('Your bio data API');
```
...
```json
{
  ...
  "timeline": [
    ...
    { "year": "2026", "event": "Released personal homepage bxyaa-card" }
  ],
  "projects": [
    {
    ...
    {
      "name": "bxyaa-card",
      "url": "https://github.com/kssssxg/bxyaa-card",
...
3. **Proxy Server**: If the API does not support CORS, you can use a proxy server (such as the `cros.bxyaa.me` in bio.html)
...
- Repository: [bxyaa-card](https://github.com/kssssxg/bxyaa-card)
